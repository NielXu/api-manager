...
class Request():
    ...
    param_map:
        ...
        It is recommended to use collections.OrderedDict since for some urls, orders of params are important.
        The params can be either a single element, or a list with multiple elements.
        If it is a list, the first element of the list is the separator, which means that how each element in the list will be separated.
    replacer:
